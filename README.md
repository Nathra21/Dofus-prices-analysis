...
This database is stores in prices.hdf5 as a pandas DataFrame and looks like this:

|                     | Blé | Blé  | Blé   | Orge | Orge  | Orge   | Avoine | Avoine | Avoine |  ...   |
|---------------------|-----|------|-------|------|-------|--------|--------|--------|--------|--------|
|                     | x1  | x10  | x100  | x1   | x10   | x100   | x1     | x10    | x100   |  ...   |
